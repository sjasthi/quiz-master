...
| 6          | 2026-06-22 00:00:00                                                                             | FP4          | ?      | Created the instructor dashboard under a new "instructor" folder anf four static PHP pages.     | Student Dashboard and  pages for taking quizzes     | ?         | integration; promote to github; all are in sync |
| 7          | 2026-06-29 00:00:00                                                                             | FP5          | ?      |   Wired the student quiz flow end-to-end, unified the student and instructor pages, and set up a demo landing page + run instructions.   | Enhance student dashboard with UI updates, attempts, and submit button     | ?         | integration; promote to github; all are in sync |
